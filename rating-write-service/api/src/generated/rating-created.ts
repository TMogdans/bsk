...
export const protobufPackage = "rating.v1";

export interface RatingCreated {
  id: string;
}

function createBaseRatingCreated(): RatingCreated {
  return { id: "" };
}
...
export const RatingCreated = {
  ...
  fromJSON(object: any): RatingCreated {
    return { id: isSet(object.id) ? globalThis.String(object.id) : "" };
  },

  toJSON(message: RatingCreated): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
