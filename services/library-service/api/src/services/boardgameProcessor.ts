...
import type { BaseMessage, BoardgameMessage } from "../types/messages";
...
export default class BoardgameProcessor
  extends baseProcessor<Boardgame>
  implements ProcessorInterface<Boardgame>
{
  ...
  try {
    ...
    this.message = message as BoardgameMessage;
  } catch (e) {
    console.log(e);
  }
}
